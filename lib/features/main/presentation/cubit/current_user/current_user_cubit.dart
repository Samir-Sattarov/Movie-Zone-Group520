...
class CurrentUserCubit extends Cubit<CurrentUserState> {
  ...
  CurrentUserCubit(this.getCurrentUserUsecase, this.editCurrentUserUsecase) : super(CurrentUserInitial());
  ...
  save(UserEntity user) async {
    ...
    final response = await editCurrentUserUsecase.call(EditCurrentUserUsecaseParams(user));
